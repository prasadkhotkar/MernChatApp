    ...
    <Dialog open>
      <Stack p={{xs:"1rem",sm:"2rem"}} maxWidth={"25rem"}>
...

        {
          ...
          sampleNotifications.map(({sender,_id})=><NotificationItem sender={sender} _id={_id} handler={friendRequestHandler} key={_id} />) :<Typography textAlign={"center"}>0 notifications</Typography>
        }
      </Stack>
    </Dialog>
  )
